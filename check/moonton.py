...
# File           : proxy.py                                  #
# Github         : https://github.com/ngeteng                #
# Facebook       : https://www.sans.eu.org                   #
# Python version : 3.7++                                     #
##############################################################
...
def authors():
    style = f.figlet_format("Moonton Bot www.sans.eu.org")
    print(style)
  ...
  def main(self):
    ...
    if os.path.exists(
      ...
      if len(
        ...
        exit(
          '\033[93m[!] Empas tidak ada atau tidak valid pastikan berformat email:pass atau email|pass'
        )
      print(
        '[+]\033[93mTotal {0} account'.format(
          str(
            len(
              self.userdata
            )
      ...
      ask = input(
        '[?]\033[93m Apakah ingin menggunakan proxy?(\033[92mDisarankan\033[0m) [Y/t]: '
      )
      if ask.lower(
      ).strip(
      ) == 'y':
